...
export { default as deleteAffiliate } from './deleteAffiliate';
export { default as getAffiliate } from './getAffiliate';
export { default as getAffiliates } from './getAffiliates';
export { default as updateAffiliate } from './updateAffiliate';
